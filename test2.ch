...
//taunt
void blind(){
    printf("Cave Johnson: Do you have a slander for the large sentry? Yes or No?\n\n");
    scanf("%s",&j, &k);
    if(j=="Yes" || k=="No"){
        if(j=="Yes"){
...
void intro(){
    ...
    sleep(2);
    printf("Boc in a yellow power suit: Wh-OH Mc GOD!\n\n");
    sleep(2);
...
escaped and the sentry was defeated.\n\n", w, w, w);
                        sleep(2);
                        printf("Cave Johnson: Congratulations! cou won!\n\n");
                        sleep(2);
